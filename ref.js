...
<body>
    <h1>Space invaders are attacking Nology galaxy...press the button bellow to counter-attack and to destroy the invaders.</h1>
    <p>Ships</p>
    <section id="ships">
    ...
    <script>
        ...
        const displayDamage = () => {
            ...
            if(ships[randomPosition].points <= 0 && ships[randomPosition].name === "MotherShip") {
                endGame();
